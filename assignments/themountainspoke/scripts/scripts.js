...
weatherObject.open('GET', 'https://api.wunderground.com/api/5013cd1f1eba4d2a/conditions/q/MN/Franklin.json', true);
...
weatherObjectday.open('GET', 'https://api.wunderground.com/api/5013cd1f1eba4d2a/forecast/q/MN/Franklin.json', true);
